          ...
          <div class="top-info ps-2">
            <small class="me-3"
              ...
              <a href="#" class="text-white"
                >General Santos City, Philippines</a
              ></small
            >
            <small class="me-3"
              ><i class="fas fa-envelope me-2 text-secondary"></i
              ><a href="#" class="text-white">Agrimart@gmail.com</a></small
            >
          </div>
        </div>
      </div>
                    ...
                    <div class="container px-0">
                        <nav class="navbar navbar-light bg-white navbar-expand-xl" v-bind:class=" { 'navbarOpen': show }">
                            ...
                            <div class="collapse navbar-collapse bg-white" id="navbarCollapse" :class="{ 'show': show }"  >
                                <div class="navbar-nav mx-auto">
                                    <router-link to="/" class="nav-item nav-link" >Home</router-link>
                                    <router-link :to="{name: 'FarmerProducts'}" class="nav-item nav-link" >My Products</router-link>
